...
<div class="wizard padding-t-5">
    ...
    echo form_open('Client_entry', $attributes);
    ?>
    <div id="personal-field" >
        <div class="col-lg-12 padding-t-5">
            <div class="col-lg-8">
                ...
                <div class="col-md-3">
                    <div class="group">      
                        <input type="text" required name="pan" id="pan" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>PAN.</label>
                        <span style="color:red"><?php echo form_error('pan'); ?></span>
                    </div>                                                       
                </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-4">
                    ...
                    if (form_error('cphone')) {
                        echo "This field is invalid";
                    } else
                        echo " ";
                    ?>>      
                        <input type="text" required name="cphone" value="<?php echo set_value('cphone'); ?>"  id="cphone" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-md-4">
                    <div class="group" data-validationError=<?php
                    if (form_error('cemail')) {
                        echo "This field is invalid";
                    } else
                        echo " ";
                    ?>>      
                        <input type="text" required name="cemail" value="<?php echo set_value('cemail'); ?>"  id="cemail" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-md-4">
                    ...
                    if (form_error('cwww')) {
                        ...
                        echo " ";
                    ?>>      
                        <input type="text" required name="cwww" value="<?php echo set_value('cwww'); ?>"  id="cwww" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>www</label><span id="email-error" class="signup-error"></span>
                        <span style="color:red"><?php echo form_error('cemail'); ?></span>
                    </div>                                                       
                </div>
                ...
                <div class="col-md-8">
                    <div class="group" data-validationError=<?php
                    if (form_error('caddress')) {
                        echo "This field is invalid";
                    } else
                        echo " ";
                    ?>>      
                        <textarea name="caddress" id="caddress" class="textarea" rows="3" cols="5"></textarea>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                ...
                <div class="col-md-2 select">
                    ...
                    <select class="select-text" required name="ccountry" id="country">
                ...
                <div class="col-md-2 select">  
                    ...
                    <select class="select-text" required name="cstate" id="state">
                        <option value="" disabled selected></option>
                    </select>
                    <span class="select-highlight"></span>
                    <span class="select-bar"></span>
                ...
                <div class="col-md-2 select"> 
                    ...
                    <select class="select-text" required name="ccity" id="city">
                        <option value="" disabled selected></option>
                    </select>
                    <span class="select-highlight"></span>
                    <span class="select-bar"></span>
...
//# sourceURL=pen.js
        ...
        <div id="demographics-field" style="display:none" >
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="group">      
                        <input type="text" required name="lsp"  id="lsp" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>List of Service Provided</label>
                        <span style="color:red"><?php echo form_error('lsp'); ?></span>
                    </div>                                                       
                </div>
            ...
            <div class="col-md-12 navbar-btn" id='lspTable'></div>
        </div>
    ...
    <div id="experiance-field" style="display:none" >
            ...
            <div class="col-md-12 navbar-btn" id='clctTable'></div>
        </div>

        <div id="bankdetails-field"  style="display:none;">
            <div class="col-md-4">
                <div class="group">      
                    <input type="text" required name="caccname"  id="caccname" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Account Name</label>
                    <span style="color:red"><?php echo form_error('caccname'); ?></span>
                </div>                                                       
            </div>
            <div class="col-md-4">
                <div class="group">      
                    <input type="text" required name="caccno"  id="caccno" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Account No</label>
                    <span style="color:red"><?php echo form_error('caccno'); ?></span>
                </div>                                                       
            </div><div class="col-md-4">
                <div class="group">      
                    <input type="text" required name="cbankname"  id="cbankname" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Bank Name</label>
                    <span style="color:red"><?php echo form_error('cbankname'); ?></span>
                </div>                                                       
            </div>
            <div class="col-md-4">
                <div class="group">      
                    <input type="text" required name="cbranchname"  id="cbranchname" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Branch Name</label>
                    <span style="color:red"><?php echo form_error('cbranchname'); ?></span>
                </div>                                                       
            </div>
            <div class="col-md-4">
                <div class="group">      
                    <input type="text" required name="cifsc"  id="cifsc" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>IFS Code</label>
                    <span style="color:red"><?php echo form_error('cifsc'); ?></span>
                </div>                                                       
            </div>
        </div>
        ...
        <div class="col-md-12" id="contact-field"  style="display:none;">
            ...
            <div class="col-md-4">
                ...
                if (form_error('phone')) {
                    ...
                    echo " ";
                ?>>      
                    <input type="text" required name="bpsd" value="<?php echo set_value('bpsd'); ?>"  id="bpsd" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Billing Period Start Date</label><span id="phone-error" class="signup-error"></span>
                    <span style="color:red"><?php echo form_error('bpsd'); ?></span>
                </div>                                                       
            </div>
            <!--                 phone end 
            ...
            <div class="col-md-4">
                ...
                if (form_error('dd')) {
                    ...
                    echo " ";
                ?>>      
                    <input type="date" required name="dd" value="<?php echo set_value('dd'); ?>"  id="dd" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Deployment Date</label><span id="email-error" class="signup-error"></span>
                    <span style="color:red"><?php echo form_error('dd'); ?></span>
                </div>                                                       
            </div>
            ...
            <div class="col-md-8">
                <div class="group" data-validationError=<?php
                if (form_error('baddress')) {
                    echo "This field is invalid";
                } else
                    echo " ";
                ?>>      
                    <textarea name="baddress" id="baddress" class="textarea" rows="3" cols="5"></textarea>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Address</label><span id="address-error" class="signup-error"></span>
            ...
            <div class="col-md-2 select">
                <!--select title="Select Country" name="regcountry" class="form-control" id="country-name"-->
                <select class="select-text" required name="bcountry" id="country">
                    <option value="" disabled selected></option>
                    <?php
                    foreach ($geCountries as $key => $element) {
                        echo '<option value="' . $element['country_id'] . '">' . $element['country_name'] . '</option>';
            ...
            <div class="col-md-2 select">  
                <!--select title="Select State" name="state_name" class="form-control" id="state-name"-->
                <select class="select-text" required name="bstate" id="state">
                    <option value="" disabled selected></option>
                </select>
                <span class="select-highlight"></span>
                <span class="select-bar"></span>
            ...
            <div class="col-md-2 select"> 
                <!--select title="Select City" name="city_name" class="form-control" id="city-name"--> 
                <select class="select-text" required name="bcity" id="city">
                    <option value="" disabled selected></option>
                </select>
                <span class="select-highlight"></span>
                <span class="select-bar"></span>
            ...
            <div class="col-md-2">
                ...
                if (form_error('pincode')) {
                    ...
                    echo " ";
                ?>>      
                    <input type="text" required name="bpincode" value="<?php echo set_value('bpincode'); ?>"  id="bpincode" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Pincode</label><span id="phone-error" class="signup-error"></span>
                    <span style="color:red"><?php echo form_error('bpincode'); ?></span>
                </div>                                                       
            </div>
            <!--                 pincode end -->
            <div class="col-lg-12">
                <h1> <span>Deployment Address</span></h1>
                <div class="clearfix"></div>                                    
            </div>
            ...
            <div class="col-md-8">
                <div class="group" data-validationError=<?php
                if (form_error('daddress')) {
                    echo "This field is invalid";
                } else
                    echo " ";
                ?>>      
                    <textarea name="daddress" id="daddress" class="textarea" rows="3" cols="5"></textarea>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Address</label><span id="address-error" class="signup-error"></span>
                    <span style="color:red"><?php echo form_error('daddress'); ?></span>
                </div>                                                       
            </div>
            <!--
                             Address end 
            ...
            <div class="col-md-2 select">
                <!--select title="Select Country" name="regcountry" class="form-control" id="country-name"-->
                <select class="select-text" required name="dcountry" id="country">
                    <option value="" disabled selected></option>
                    <?php
                    foreach ($geCountries as $key => $element) {
                        echo '<option value="' . $element['country_id'] . '">' . $element['country_name'] . '</option>';
            ...
            <div class="col-md-2 select">  
                <!--select title="Select State" name="state_name" class="form-control" id="state-name"-->
                <select class="select-text" required name="dstate" id="state">
                    <option value="" disabled selected></option>
                </select>
                <span class="select-highlight"></span>
                <span class="select-bar"></span>
            ...
            <div class="col-md-2 select"> 
                <!--select title="Select City" name="city_name" class="form-control" id="city-name"--> 
                <select class="select-text" required name="dcity" id="city">
                    <option value="" disabled selected></option>
                </select>
                <span class="select-highlight"></span>
                <span class="select-bar"></span>
            ...
            <div class="col-md-2">
                <div class="group" data-validationError=<?php
                if (form_error('dpincode')) {
                    echo "This field is invalid";
                } else
                    echo " ";
                ?>>      
                    <input type="text" required name="dpincode" value="<?php echo set_value('dpincode'); ?>"  id="dpincode" >
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Pincode</label><span id="phone-error" class="signup-error"></span>
                    <span style="color:red"><?php echo form_error('dpincode'); ?></span>
                </div>                                                       
            </div>
            <!--                 pincode end -->
