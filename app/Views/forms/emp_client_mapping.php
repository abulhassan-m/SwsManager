...
<div class="column-half padding-t-7 margin-t-b-15 ">
    ...
    echo form_open('Employee/map', $attributes);
    ?>
    <div class="form-card">
        <div class="column-full">
            <div class="column-half">
                <h2 class="subtitle1">Employee Deployment Form </h2>
            </div>
        </div>
            ...
            <div class="column-33 ">
                ...
                <div class="column-full">
                    <div class="group">    
                        ...
                        <span class="signup-error"><?php echo form_error('amount'); ?></span>
                    </div>                                                       
                </div>
                <!--- DOB Selection  Ended-->
            </div>            
...
$.ajax({
    url: "http://localhost/manage-app/transaction/fetchallempdata/1",
    type: 'post',
    dataType: "json",
    data: {},
    beforeSend: function () {},
...
$.ajax({
    url: "http://localhost/manage-app/transaction/fetchallclientdata/1",
    type: 'post',
    dataType: "json",
    data: {},
    beforeSend: function () {},
