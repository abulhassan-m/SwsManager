        ...
        <div class="col-lg-12 padding-t-5">
            <div class="col-lg-8">
                ...
                <div class="col-md-6">
                    ...
                    <div class="group">      
                        <input type="text" required name="firstname" required  value="<?php echo set_value('firstname'); ?>"  id="firstname"  pattern="(?=.*[a-z])(?=.*[A-Z]).{2,}">
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>First Name</label>
                        <div class="requirements">      Required Field Empty !    </div>
                        <span id="name-error" class="signup-error" style="color:red"><?php echo form_error('firstname'); ?></span>
                    </div>                                                       
                </div>
                ...
                <div class="col-md-6">
                    ...
                    ?> >      
                        ...
                        <div class="requirements">      Required Field Empty !    </div>
                        <span  id="name-error" class="signup-error"  style="color:red"><?php echo form_error('lastname'); ?></span>
                    </div>  
                ...
                <div class="col-md-3">
                    ...
                    ?> >      
                        ...
                        <span style="color:red"><?php echo form_error('pobirth'); ?></span>
                    </div>                                                       
                </div>
            ...
            <div class="col-lg-2">                              
                ...
                <div class="col-md-12">
                    ...
                    ?> >      
                        ...
                        <span style="color:red"><?php echo form_error('dobirth'); ?></span>
                    </div>                                                       
                </div>
                ...
                <div class="col-md-12 select">      
                    ...
                    <span style="color:red"><?php echo form_error('matstat'); ?></span>
                ...
                <div class="col-md-12">
                    <div class="group" >      
                        ...
                        <span style="color:red"><?php echo form_error('dojoin'); ?></span>
                    </div>                                                       
                </div>
                ...
                <div class="col-md-12">
                    <div class="group" >      
                        <input class="date_input" type="date" required name="doleft" value="<?php echo set_value('doleft'); ?>"  id="doleft" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label style="line-height: 0px; font-size: 12px;">Date Left</label>
                        <span style="color:red"><?php echo form_error('doleft'); ?></span>
                    </div>                                                       
                </div>
...
//# sourceURL=pen.js
    ...
    <div id="demographics-field" style="display:none" >
            ...
            <div class="col-md-4">
                    <div class="group">      
                        <input type="text" required name="fathername"  id="fathername" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>Father Name</label>
                        <span style="color:red"><?php echo form_error('fathername'); ?></span>
                    </div>                                                       
                </div>
            <div class="col-md-4">
                    <div class="group">      
                        <input type="text" required name="mothername"  id="mothername" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>Mother Name</label>
                        <span style="color:red"><?php echo form_error('mothername'); ?></span>
                    </div>                                                       
                </div>
            <div class="col-md-4">
                    <div class="group">      
                        <input type="text" required name="spousename"  id="spousename" >
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label>Spouse Name</label>
                        <span style="color:red"><?php echo form_error('spousename'); ?></span>
                    </div>                                                       
                </div>
            ...
            <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('fatherocc'); ?></span>
                    </div>                                                       
                </div>
    ...
    var dat = {nosch: parseInt(document.getElementById("nosch").value)};
                $.ajax({
    url: 'http://localhost/sec-web-app/applnentry',
    type: 'POST',
    dataType: 'text',
    data: dat ,
})
...
var row = parseInt(document.getElementById("nosch").value);
                var tbody='<table class="table table-bordered padding-t-5">     <thead>      <th>Sl.No</th>  <th>Name</th>        <th>Age</th>           <th>Relationship</th>'+
                        '</thead><!-- tbody id="data">     </tbody--><tbody> ';
                
for (var r=1;r<=row;r++) {
                    tbody+=' <tr><td>'+r+'</td> <td> <input type="text" name="first'+r
                            +'" />  </td> <td> <input type="text" name="second'+r+'" />  </td> <td> <input type="text" name="third'+r+'" />  </td>  </tr>';
                }
            ...
            <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span class="bar"></span>
                        <label>Nominee</label>
                        <span style="color:red"><?php echo form_error('nominee'); ?></span>
                    </div>                                                       
            </div>
    ...
    <div id="experiance-field"  style="display:none;">
        <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('eduqua'); ?></span>
                    </div>                                                       
                </div>
        ...
        <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('yearexp'); ?></span>
                    </div>                                                       
                </div>
        <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('pubexp'); ?></span>
                    </div>                                                       
                </div>
         <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('nopubexp'); ?></span>
                    </div>                                                       
                </div>
         <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('nopriexp'); ?></span>
                    </div>                                                       
                </div>
         ...
         <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('cerver'); ?></span>
                    </div>                                                       
                </div>
         <div class="col-md-4">
                    <div class="group">      
                        ...
                        <span style="color:red"><?php echo form_error('lang'); ?></span>
                    </div>                                                       
                </div>
    </div>
